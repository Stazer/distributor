<?php
namespace distributor\engines;

abstract class LinearProgramEngine extends \distributor\Engine
{
    /**
    ...
    {
        $linear_program = new \distributor\LinearProgram();
    ...
    { 
        ...
        {
            $authentication = new \distributor\ssh\PasswordAuthentication($this->get_configuration()['SSH']['USERNAME'], $this->get_configuration()['SSH']['PASSWORD']);
            $connection = new \distributor\ssh\Connection($this->get_configuration()['SSH']['HOSTNAME'], $this->get_configuration()['SSH']['FINGERPRINT'], $authentication);
    ...
    {
        return \distributor\LPFileWriter::write($linear_program);
    }
